...
const GOVERNMENT_KNOWLEDGE_BASE = [
  ...
  {
    id: "kb_passport",
    title: "Indian Passport Services (Passport Seva)",
    category: "Identity & Travel",
    content: "Overview: Passport Seva enables citizens to apply for fresh or reissue of Passport online. Eligibility: All Indian citizens are eligible. Documents: Address Proof (Aadhaar, utility bills, rent agreement), Date of Birth Proof (Birth certificate, PAN card, school leaving certificate). Fees: Fresh passport (36 pages): ₹1,500; Tatkaal: ₹3,500. Processing Time: Normal: 15-30 days; Tatkaal: 1-3 days. Step-by-Step Guide: 1. Register on Passport Seva Portal, 2. Fill out form, 3. Pay fees & Schedule Appointment, 4. Visit Passport Seva Kendra (PSK) for biometric verification, 5. Police verification, 6. Delivery via speed post. Official Website: https://passportindia.gov.in. Helpline: 1800-258-1800.",
    benefits: "Official international identity document and proof of citizenship.",
    eligibility: "All Indian Citizens (minor, adult, senior).",
    deadline: "Continuous",
  },
  {
    id: "kb_dl",
    title: "Driving License Services (Sarathi Portal)",
    category: "Transport",
    content: "Overview: Ministry of Road Transport and Highways (MoRTH) Sarathi portal offers computerized DL application and renewal. Eligibility: Minimum 18 years for gear vehicles, 16 years for non-gear. Documents: Aadhaar Card, Age Proof, Learner's License, Form 1A Medical Certificate (for 40+ age). Fees: Learner's License: ₹150; Permanent DL: ₹300; Renewal: ₹200. Processing Time: Learner's: Instant on test pass; Permanent DL: 15-20 days after test. Step-by-Step Guide: 1. Apply online via Sarathi, 2. Book Learner's test slot, 3. Complete test, 4. Apply for Permanent DL after 30 days, 5. Appear for driving track test, 6. Dispatched via speed post. Official Website: https://parivahan.gov.in. Helpline: +91-120-4925505.",
    benefits: "Legally drive motor vehicles and serves as official photo ID.",
    eligibility: "Indian residents over 18 years passing the standard driving test.",
    deadline: "Continuous",
  },
  {
    id: "kb_birth",
    title: "Compulsory Registration of Birth Certificate",
    category: "Civil Registry",
    content: "Overview: Registration of births under the RBD Act of 1969. Eligibility: Every child born in India. Must be registered within 21 days at local registrar. Documents: Hospital discharge summary, Aadhaar of parents, birth declaration form. Fees: Free within 21 days; late registration fees apply up to ₹50. Processing Time: 7-10 working days. Step-by-Step Guide: 1. Log in to Civil Registration System (CRS) portal or visit local Municipal Office, 2. Fill out Birth Registration Form, 3. Upload parent IDs and hospital discharge proof, 4. Registrar approves, 5. Download digital copy from the website with verified QR code. Official Website: https://crsorgi.gov.in. Helpline: Local Municipal Helpdesk.",
    benefits: "Primary proof of age, date, and place of birth for education/passport.",
    eligibility: "All infants born inside municipal or state jurisdictions.",
    deadline: "21 days for free registry; up to 1 year with late fee.",
  },
  {
    id: "kb_electricity",
    title: "National Digital Electricity Bill & Fault Reporting",
    category: "Utilities",
    content: "Overview: Unified utility bill payment and fault registry. Eligibility: All residential and commercial electricity consumers under state DISCOMs. Documents: Consumer ID / Account number, Registered Mobile Number. Fees: Bill payments are dynamic based on state tariff unit rates. Fault reporting is completely free. Processing Time: Meter faults: 48-72 hours. Online bill update: Instant. Step-by-Step Guide: 1. Select State DISCOM on National Portal, 2. Enter 10-digit Consumer ID, 3. View billing amount and download official PDF, 4. Pay via BBPS gateway, 5. Download instant payment receipt. Official Website: https://www.urjamitra.in. Helpline: 1912 (National Power Hotline).",
    benefits: "Instant utility dispute lodging and digital receipt tracking.",
    eligibility: "All registered electric DISCOM connection holders.",
    deadline: "Monthly dynamic deadlines.",
  },
  {
    id: "kb_widow_pension",
    title: "Indira Gandhi National Widow Pension Scheme (IGNWPS)",
    category: "Social Welfare",
    content: "Overview: Provides financial security and pension to widows living below the poverty line (BPL). Eligibility: Widows aged 40-79 years who belong to BPL families. Documents: BPL Card, Husband's Death Certificate, Aadhaar Card, Age Proof, Bank Passbook copy. Fees: Completely free application. Processing Time: 30-45 days. Benefits: ₹300/month (age 40-59) and ₹500/month (age 60+). Step-by-Step Guide: 1. Download application form from State Social Welfare website, 2. Get verification signature from Gram Panchayat/Ward officer, 3. Upload to State Welfare Portal along with BPL card and death certificate, 4. Verification by Block Development Officer, 5. Direct Benefit Transfer (DBT) to bank account. Official Website: https://nsap.nic.in. Helpline: 1800-111-555.",
    benefits: "Direct cash pension of ₹300-₹500 monthly straight to bank account.",
    eligibility: "Widowed women aged 40-79 under the official BPL line.",
    deadline: "Continuous",
  },
  {
    id: "kb_aadhaar",
    title: "Unique Identification Authority of India (UIDAI) Aadhaar Services",
    category: "Identity & Authentication",
    content: "Overview: UIDAI offers Aadhaar enrollment, biometric updates, and e-KYC. Eligibility: All residents of India. Documents: Proof of Identity (Passport, PAN, Voter ID), Proof of Address (utility bills, bank statement). Fees: Enrollment is Free. Demographic update: ₹50. Biometric update: ₹100. Processing Time: 10-30 days. Step-by-Step Guide: 1. Book appointment on UIDAI website, 2. Visit Aadhaar Seva Kendra, 3. Provide fingerprint, iris scan, and photo, 4. Submit identity document copies, 5. Receive 14-digit Enrollment ID, 6. Check status and download e-Aadhaar online. Official Website: https://uidai.gov.in. Helpline: 1947.",
    benefits: "Universal 12-digit digital biometric identity across India.",
    eligibility: "All residents of India (including infants).",
    deadline: "Continuous (Updates recommended every 10 years).",
  }
];
